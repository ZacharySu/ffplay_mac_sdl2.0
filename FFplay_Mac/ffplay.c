...
int ffplay(int argc, char **argv)
{
    ...
    char argv1[2][100]; //= {"ffplay", "/Users/sunjun/Desktop/desktop/测试视频/mkv/roman.mkv"};
    strcpy(argv1[0], "ffplay");
    strcpy(argv1[1], "1942Sample.avi");

    parse_loglevel(argc, argv1, options);
    ...
    show_banner(argc, argv1, options);

    parse_options(NULL, argc, argv1, options, opt_input_file);
